...
<script type="text/javascript">
		...
		function menuPontoClick() {
		    alert("Clique em um ponto do mapa para inserir um marcador.");
		...
		function menuTrianguloClick() {
		    alert("Clique em três pontos do mapa para criar um triângulo");
            acao.atual = acao.TRIANGULO;
            escondeMenu("m2");
		}
		function menuRetanguloClick() {
		    alert("Clique em quatro pontos do mapa para criar um retângulo.");
